/* The script is placed inside an immediately invoked function expession
...
(function() {
	...
	var hotel = {
		name: "Park",
		roomRate: 240, // Amount ib dollars
	...
	function offerExpires(today) {
		...
		dayNames = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thirsday", "Friday", "Saturday"];

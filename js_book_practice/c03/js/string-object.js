// Create a variable called saying to hold string that will be used
...
// Find the character with an index of 12 in the string and it to the msg variable
msg += "<h2>character index: 12</h2><p>" + saying.charAt(12) + "</p>";
// Find the index number of the fisrt instance of "ee" in the string and add it to the msg variable
...
// Find the characters with an index number on the 8-14 range in the string and add it to the msg variable
